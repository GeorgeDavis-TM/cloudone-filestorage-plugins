...
# Original file can be found at GoogleCloudPlatform / cloud-pubsub-sendmail / main.py @ https://github.com/GoogleCloudPlatform/cloud-pubsub-sendmail/blob/main/main.py
# Refer to GoogleCloudPlatform / cloud-pubsub-sendmail for more documentation @ https://github.com/GoogleCloudPlatform/cloud-pubsub-sendmail

def pubsub_sendmail(mailDict, context):
    import base64
    import os
    import smtplib
    ...
    mailServer          = mailDict["mailServer"]
    mailLocalHost       = mailDict["mailLocalHost"]
    mailForceTls        = mailDict["mailForceTls"]
    mailDebug           = mailDict["mailDebug"]
    mailMessageBody     = mailDict["mailMessageBody"]
